...
const state: FixtureMutableState = {
	...
	speechReady: false,
	voiceCommandActionId: "navigate.artifacts",
	voiceCommandConfidence: 0.98,
	...
	reset() {
		...
		this.voiceCommandActionId = "navigate.artifacts";
		this.voiceCommandConfidence = 0.98;
		this.voiceCommandsReady = false;
