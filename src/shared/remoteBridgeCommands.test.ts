...
describe("remote bridge launch commands", () => {
	test("builds Zed deep links and CLI commands for an absolute remote path", () => {
		expect(
			remoteBridgeZedUrl("couchview-project-one-11111111", "/Users/mini/Code/Project One"),
		).toBe("zed://ssh/couchview-project-one-11111111/Users/mini/Code/Project%20One");
		expect(
			remoteBridgeZedCommand("couchview-project-one-11111111", "/Users/mini/Code/Project One"),
		).toBe("zed 'ssh://couchview-project-one-11111111/Users/mini/Code/Project%20One'");
	});

	test("quotes the selected repository for the Couchview Codex launcher", () => {
		expect(
			remoteBridgeCodexCommand("couchview-project-one-11111111", "/Users/mini/Code/Project One"),
		).toBe(
	...
	test("builds separate terminal and Claude Remote Control launchers", () => {
		...
		expect(
			remoteBridgeClaudeCommand("couchview-project-one-11111111", "/Users/mini/Code/Project's App"),
		).toBe(
