...
describe("command registry", () => {
  test("contains metadata and a declared default for every command ID", () => {
    ...
    for (const commandId of COMMAND_IDS) {
      ...
      expect(Object.prototype.hasOwnProperty.call(DEFAULT_KEYBINDINGS.qwerty, commandId))
        .toBe(true);
      expect(Object.prototype.hasOwnProperty.call(DEFAULT_KEYBINDINGS.dvorak, commandId))
        .toBe(true);
    }
